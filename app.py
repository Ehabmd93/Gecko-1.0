...
app.layout = html.Div([
    html.H1("Gecko 1.0", style={'fontSize': '48px', 'fontWeight': 'bold', 'color': 'black', 'textAlign': 'center'}),
    html.H3("designed specifically for QHBW Grouting Data QC Tool", style={'textAlign': 'center'}),
...
def update_and_run_tool(contents, n_clicks, hole_id, stage, order, view_type, filename):
    ...
    if trigger_id == 'upload-data' and contents is not None:
        try:
            ...
            processing_message = "Uploading File... Hold on! Gecko is on it. Processing your data now! 🦎"
